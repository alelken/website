...
<div class="page page--home">
  ...
  <section class="hero">
    <div class="hero__container">
      <div class="hero__content">
        ...
        <p class="hero__subtitle">Building systems that heal, educate, and sustain through innovative solutions</p>
        <div class="hero__cta">
          <button class="hero__button hero__button--primary">Get Started</button>
          <button class="hero__button hero__button--secondary">Learn More</button>
        </div>
      </div>
    ...
    <div class="vision__container">
      <div class="vision__content">
        <p class="vision__text">
          Most systems we interact with daily—the ones meant to serve us—weren't designed with actual human needs in mind. They were designed for efficiency, for scale, for control.
        </p>
        <p class="vision__text">
          We believe <span class="vision__accent">technology's highest purpose</span> is fixing what's broken at the root, not automating dysfunction.
        </p>
      </div>
    </div>
  </section>
  ...
  <section class="stand-for">
    <div class="stand-for__container">
      <div class="stand-for__content">
        <p class="stand-for__text">
        ...
        <p class="stand-for__text">
          We're not interested in incremental improvements. We're <span class="stand-for__accent">rebuilding from the ground up.</span>
        </p>
      </div>
    </div>
  </section>
    ...
    <div class="approach__container">
      <div class="approach__left">
        <div class="approach__header">
          <h2 class="approach__title">Our Approach</h2>
          <div class="approach__accent-line"></div>
        </div>
      </div>
  ...
  <section class="philosophy">
    <div class="philosophy__container">
      <div class="philosophy__header">
        <h2 class="philosophy__title">Our Belief</h2>
        <div class="philosophy__accent-line"></div>
      </div>
      <div class="philosophy__content">
        <blockquote class="philosophy__quote">
          <div class="philosophy__quote-mark">"</div>
          <div class="philosophy__quote-content">
            <p class="philosophy__text">
              Real innovation isn't adding features to broken systems. It's questioning why those systems exist in their current form, and having the courage to imagine alternatives.
            </p>
            <p class="philosophy__text">
              The world doesn't need more apps. It needs solutions to problems that millions face but no one finds profitable enough to fix properly.
            </p>
            <p class="philosophy__text philosophy__text--emphasis">
  ...
  <section class="impact">
    <div class="impact__container">
      <div class="impact__header">
        <h2 class="impact__title">Impact Commitment</h2>
        <div class="impact__accent-line"></div>
      </div>
      <div class="impact__content">
        <div class="impact__text-content">
          <p class="impact__text">
            We align our work with the UN Sustainable Development Goals—not as marketing, but as a framework for accountability.
          </p>
          <p class="impact__text">
            Every project we undertake must contribute to measurable progress on problems that matter at civilizational scale.
          </p>
        </div>
